...
@WebServlet({ "/add", "/pizza/salgadas", "/pizza/doces", "/bebidas", "/crepes", "/buscarProduto", "/espaguetes", "/sobremesas"})
@MultipartConfig
public class ControllerProduto extends HttpServlet {
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ClassNotFoundException, SQLException, IOException {
